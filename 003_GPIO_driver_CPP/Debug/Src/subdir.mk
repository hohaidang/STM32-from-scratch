...
OBJS += \
./Src/005_blinkLEDwithTimer.o \
./Src/syscalls.o \
./Src/sysmem.o 

CPP_DEPS += \
./Src/005_blinkLEDwithTimer.d 


# Each subdirectory must supply rules for building sources it contributes
Src/005_blinkLEDwithTimer.o: ../Src/005_blinkLEDwithTimer.cpp
	arm-none-eabi-g++ "$<" -mcpu=cortex-m4 -std=gnu++14 -g3 -DSTM32 -DSTM32F4 -DSTM32F446RETx -DDEBUG -DNUCLEO_F446RE -c -I../Inc -O0 -ffunction-sections -fdata-sections -fno-exceptions -fno-rtti -fno-threadsafe-statics -fno-use-cxa-atexit -Wall -fstack-usage -MMD -MP -MF"Src/005_blinkLEDwithTimer.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
