...
int main(void) {
  ...
  LED2.gpio_init(GPIO_PIN_NO_5, GPIO_MODE_OUT, GPIO_SPEED_LOW, GPIO_OP_TYPE_PP,
                 GPIO_NO_PUPD);
  gpio_handler user_button(GPIOC);
  user_button.gpio_init(GPIO_PIN_NO_13, GPIO_MODE_IN, GPIO_SPEED_LOW);
