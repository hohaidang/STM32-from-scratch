...
public:
    ...
    // Data read and write
    uint8_t gpio_read_from_input_pin() const;
    uint16_t gpio_read_from_input_port() const;
    void gpio_write_to_output_pin(const uint8_t value);
    void gpio_write_to_output_port(const uint16_t value);
...
private:
    ...
    void gpio_irq_config(const uint8_t irq_number, const uint8_t en_or_di);
    void gpio_irq_priority_config(const uint8_t irq_number, const uint8_t irq_priority);
