...
#define ENABLE 1UL
extern "C" {
// void config_irq(u8 irq_number, u8 en_or_di);
// void config_irq_priority(u8 irq_number, u8 irq_priority);
}
...
typedef struct {
  ...
  __vo u32
      IPR[60U]; /*!< Offset: 0x300 (R/W)  Interrupt Priority Register (32Bit) */
...
typedef struct {
  ...
  __vo u32 AIRCR;   /*!< Offset: 0x00C (R/W)  Application Interrupt and Reset
                       Control Register */
  __vo u32 SCR;     /*!< Offset: 0x010 (R/W)  System Control Register */
  __vo u32 CCR;     /*!< Offset: 0x014 (R/W)  Configuration Control Register */
  __vo u32 SHPR[3]; /*!< Offset: 0x018 (R/W)  System Handlers Priority Registers
                       (4-7, 8-11, 12-15) */
  __vo u32 SHCSR;   /*!< Offset: 0x024 (R/W)  System Handler Control and State
                       Register */
...
#define SYSTICK (reinterpret_cast<SysTick_Reg_t *>(SysTick_BASEADDR))
/*!< NVIC configuration struct */
#define NVIC (reinterpret_cast<NVIC_Reg_t *>(NVIC_BASEADDR))
/*!< SCB configuration struct */
#define SCB (reinterpret_cast<SCB_Reg_t *>(SCB_BASEADDR))
#endif
